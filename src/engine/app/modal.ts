pg.modal = function () {
  ...
  const notice = function (msg, type) {
  ...
  const floater = function (id, title, html, width, top) {
  ...
  const confirm = function (msg, title, callback) {
    const $fader = jQuery('<div class="modal fader admin">');
  ...
  const form = function (html, title, callback) {
    const $fader = jQuery('<div class="modal fader admin">');
